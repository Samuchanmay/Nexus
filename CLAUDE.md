# CLAUDE.md — EMET (bridge hacia la bóveda Obsidian)
...
9. **Auditoría previa al cierre:** responder el checklist de `emet/03_SYSTEM_RULES.md`. Si algo aplica, la tarea no está cerrada.
10. **Al terminar la sesión:** registrar la sesión en `emet/05_AI_HANDOFF.md`.

## Sincronización con Open Code

Ambos asistentes (Claude y Open Code) trabajan sobre la misma bóveda. Cuando Claude detecte una decisión, bug, mejora UX, auditoría o cambio de arquitectura, debe registrarlo en la bóveda correspondiente y actualizar changelog + handoff.
