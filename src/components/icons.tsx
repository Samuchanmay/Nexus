...
export const IconSearch = ({ className = "w-[18px] h-[18px]" }: P) => (
  <svg {...base} className={className}><circle cx="11" cy="11" r="7" /><path d="M21 21l-4.3-4.3" /></svg>);
export const IconChevronDown = ({ className = "w-[18px] h-[18px]" }: P) => (
  <svg {...base} className={className}><polyline points="6 9 12 15 18 9" /></svg>);
