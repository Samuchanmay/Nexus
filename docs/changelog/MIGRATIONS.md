...
> Migraciones **additivas** en `supabase/migrations/` (0002 … 0024). El schema canónico que las resume vive en `supabase/schema.sql` (432 líneas). Reglas en `docs/coding/SUPABASE.md`.
...
1. Nunca editar una migración aplicada: agregar `0025_*.sql` y reflejarlo en `schema.sql`.
